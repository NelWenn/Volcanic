package net.vulkanmod.rendergraph.core.pipeline;
...
@CoreGfxPipeline(name = "position_color_lightmap")
public final class PositionColorLightmapPipeline implements PipelineDefinition {
    ...
    @Sampler(binding = 2) int Sampler2;
}
