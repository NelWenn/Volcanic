...
@GfxPipeline(basePath = "radiance_light", vertex = "radiance_light", fragment = "radiance_light", vertexFormat = VertexFormatRef.NONE)
public final class RadianceLightPipeline implements PipelineDefinition {
