...
public class VulkanImage {
    ...
    // depth-only view for sampling depth-stencil attachments (main view carries stencil, not samplable)
    private long depthSampleView = VK_NULL_HANDLE;
    public long getDepthSampleView() {
        if (this.depthSampleView == VK_NULL_HANDLE) {
            this.depthSampleView = createImageView(this.id, this.format, VK_IMAGE_ASPECT_DEPTH_BIT, this.mipLevels);
        }
